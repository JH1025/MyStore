...
//image의 download 
//같은방식으로 열고 다운로드.....!!!!!
public class ProductImageParse {
	Bitmap bmImg;
	String fileUrl = "http://183.106.250.84/getProductImage.php";
	String imageUrl = "http://183.106.250.84/getProductImage.php";
	public ProductImageParse(){
	...
	//imageparse
	public void downloadFile(String productID) {
		URL myFileUrl = null;
		...
		try {
			...
			buffer.append("id").append("=").append(productID);
